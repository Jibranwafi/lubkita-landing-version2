<div 
  class="flex flex-col w-full p-4 md:p-20 min-h-screen bg-center bg-no-repeat md:bg-cover"
  style="background-image: url('/page-ldr-wallpaper.png'); background-position: bottom;"
>
